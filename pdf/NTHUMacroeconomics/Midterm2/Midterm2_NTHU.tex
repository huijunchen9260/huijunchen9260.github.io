...
$MRS_{l,C}=w(1-t)$.  Compute the equilibrium labor $N$ to be closest to
\answer{A}
\begin{tasks}(1)
    \task $N=0.31$
    \task $N=0.50$
...
\details{
Given $z = 1, \alpha = 0.5, t = 0.2$,
compute $ \displaystyle
\alpha(1-t) = 0.5 \times 0.8 = 0.4,
1 - \alpha = 0.5 $.
Thus
$ \displaystyle
A = \frac{0.4}{0.4 + 0.5}
...
Then
$ \displaystyle
N = \frac{A}{1 + A} = \frac{4/9}{1 + 4/9} = \frac{4/9}{13/9} = \frac{4}{13} \approx 0.31
$
}
...
\details{
Given $ \displaystyle
z = 1, \alpha = 0.33, t = 0.3,
    $
compute
$ \displaystyle
\alpha(1-t) = 0.33 \times 0.7 = 0.231,
1 - \alpha = 0.67.
$
Thus
$ \displaystyle
A = \frac{0.231}{0.231 + 0.67}
  = \frac{0.231}{0.901}
  \approx 0.2564.
$
Then
