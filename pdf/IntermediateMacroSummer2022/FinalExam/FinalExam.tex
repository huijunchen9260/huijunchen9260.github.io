...
\Question Following assumption N2, the slope of the labor supply is \answer{D} in wage and thus the labor supply curve has \answer{D} slope
\begin{tasks}(2)
...
\Question Following N1, how does the labor supply curve response to a rise in real interest rate $ r $? \answer{B}
\begin{tasks}(2)
...
\Question Using the same figures as in the choice of \ref{z'}, consider a rise in capital endowment $ G $. Which of the following figure correctly represents the movement of labor and goods market? \answer{D}

\Question Using the same figures as in the choice of \ref{z'}, consider a rise in capital endowment $ K $. Which of the following figure correctly represents the movement of labor and goods market? \answer{C}
...
\begin{itemize}
    ...
    \item households are endowed with $ H $ of current human capital at date $ 0 $, and they accumulate future human capital $ H' $ by \blue{spending $ \phi $ fraction of their time endowment to education}. The law of motion for human capital is given by
    %
    \begin{equation}
...
\Question What is the economics intuition of the this equation? \answer{D}
