...
%------------------------------------------------
\section[Diagram]{A short dictionary: diagrams $\leftrightarrow$ equations}
...
%------------------------------------------------
\section[AD]{Aggregate demand in equations (IS--LM $\Rightarrow$ AD)}
...
%------------------------------------------------
\section[SRAS]{Aggregate supply in equations (SRAS + FE)}
...
%------------------------------------------------
\section[Equilibrium]{Equilibrium and comparative statics}

%------------------------------------------------
\begin{frame}{AD--AS equilibrium (in one picture)}
\centering
\includegraphics[width=0.60\linewidth]{figADAS.jpg}
\end{frame}
