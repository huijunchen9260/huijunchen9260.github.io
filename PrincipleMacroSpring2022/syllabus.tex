...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Zoom:
        \begin{itemize}
            \item \href{https://osu.zoom.us/j/2532324996?pwd=c2cweEphWFMvTVZreHJ0MHNRNUdodz09}{zoom link}
            \item Meeting ID: 253 232 4996; Password: 553349
        \end{itemize}
    \end{itemize}
...
\begin{tabular}{|p{\bb}|p{\qq}|p{\rr}|p{\pp}|}
    ...
    \hline
        ...
        None
        &
        \href{https://virtual.oxfordabstracts.com/#/event/2506/session/33000}{MEA Annual Meeting Presentation}
    \\
    \hline
        12
        &
